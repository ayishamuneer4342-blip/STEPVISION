    ...
    return (
        <div className="fixed bottom-6 right-6 flex flex-col gap-3 z-50">
            ...
            <a
                ...
                className="bg-[#25D366] hover:bg-[#20bd5a] text-white p-3 rounded-full shadow-lg transition-transform hover:scale-110 flex items-center justify-center animate-in fade-in zoom-in duration-300"
